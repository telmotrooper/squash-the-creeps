...
rm -rf $EXPORT_PATH/$WEB_NAME
mkdir -p $EXPORT_PATH/$WEB_NAME
godot --headless --export-release "Web" $EXPORT_PATH/$WEB_NAME/index.html
cp ./https-server.py $EXPORT_PATH/$WEB_NAME/
