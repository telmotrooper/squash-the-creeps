...
func _ready():
	...
	# updating styles
	var style = $Split/EditorScroll.get('custom_styles/panel')
...
func _on_Scale_value_changed(value):
	#nodes['portrait_preview_real'].position = ($Split/Preview/Background/Positioner.position-nodes['portrait_preview_real'].size*Vector2(0.5,1))
