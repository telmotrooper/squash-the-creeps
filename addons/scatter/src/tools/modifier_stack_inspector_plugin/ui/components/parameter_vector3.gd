...
func _ready() -> void:
	_x.connect("value_changed",Callable(self,"_on_value_changed"))
	_y.connect("value_changed",Callable(self,"_on_value_changed"))
	_z.connect("value_changed",Callable(self,"_on_value_changed"))
