...
func _ready():
	_cancel.connect("pressed",Callable(self,"_on_cancel_pressed"))
	_save.connect("pressed",Callable(self,"_on_save_pressed"))
	_warning.text = ""
	_confirm_overwrite.connect("confirmed",Callable(self,"_save_preset"))
